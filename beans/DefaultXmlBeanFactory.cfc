<!---
 ...
 $Id: DefaultXmlBeanFactory.cfc,v 1.51 2008/01/20 21:50:28 scottc Exp $
...
<cfcomponent name="DefaultXmlBeanFactory"
	...
	<cffunction name="loadBeanDefinitions" access="public" returntype="void"
		...
		<cfloop from="1" to="#ArrayLen(beans)#" index="beanIx">
			...
			<cfif StructKeyExists(beanAttributes,'autowire') and listFind('no,byName,byType',beanAttributes['autowire'])>
